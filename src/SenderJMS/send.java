...
public class send {
    ...
    public static void main(String[] args) throws JMSException {
        ...
        ConnectionFactory connectionFactory =
                new ActiveMQConnectionFactory("tcp://192.168.1.3:61616?jms.watchTopicAdvisories=false"); //failover://tcp://localhost:61616
        ...
        // send the messages
        TextMessage message = session.createTextMessage("891031075331"); //ic
        ...
        if (replyMessage instanceof TextMessage) {
            ...
            List PMSList = (ArrayList) replyMessage.getObjectProperty("PMS");
            ...
            for (int i = 0; i < PMSList.size(); i++) {
                 System.out.println("...PDIList : "+ PMSList.get(i));
                System.out.println("...this is array pdi: "+ PDI[i]);
            }
