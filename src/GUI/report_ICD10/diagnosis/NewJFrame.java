...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Report and statistic of Diagnosis");
...
//                    Statement st2 = conn.createStatement();
                try {
                    ...
                    HashMap<String, String> chapter_map = new HashMap<String, String>();
...
//                        ArrayList<ArrayList<String>> data = rc.getQuerySQL(host, port, sql);
                    String param[] = {};
                    ArrayList<ArrayList<String>> data = DBConnection.getImpl().getQuery(sql, 2, param);
...
//                        tot_by_fac_list = rc.getQuerySQL(host, port, sql);
                    String param2[] = {};
                    tot_by_fac_list = DBConnection.getImpl().getQuery(sql, 1, param2);
...
//                        tot_by_gm_list = rc.getQuerySQL(host, port, sql);
                    String param3[] = {};
                    tot_by_gm_list = DBConnection.getImpl().getQuery(sql, 1, param3);
...
//                        tot_by_gf_list = rc.getQuerySQL(host, port, sql);
                    String param4[] = {};
                    tot_by_gf_list = DBConnection.getImpl().getQuery(sql, 1, param4);
...
//                        header_table.addCell(cell4);
                    ...
                    sql = "SELECT Diagnosis_Cd "
                            ...
                            + "AND CAST(Episode_Date as DATE) BETWEEN ? AND ? ";

//                        invalid_record_list = rc.getQuerySQL(host, port, sql);      
                    String param5[] = {patient_type, date1, date2};
                    invalid_record_list = DBConnection.getImpl().getQuery(sql, 1, param5);
...
//                              chapter_total_result_list = rc.getQuerySQL(host, port, sql); 
                        String param6[] = {};
                        chapter_total_result_list = DBConnection.getImpl().getQuery(sql, 1, param6);
...
//                              gender_total_result_list = rc.getQuerySQL(host, port, sql); 
                        String param7[] = {};
                        gender_total_result_list = DBConnection.getImpl().getQuery(sql, 2, param7);
...
//                              block_total_result_list = rc.getQuerySQL(host, port, sql); 
                            String param8[] = {};
                            block_total_result_list = DBConnection.getImpl().getQuery(sql, 7, param8);
...
//                                      code_total_result_list = rc.getQuerySQL(host, port, sql); 
                                String param9[] = {};
                                code_total_result_list = DBConnection.getImpl().getQuery(sql, 7, param9);
